...
document.querySelectorAll('.js-delete-todo-button'). 
      forEach((deleteButton, index) => {
          deleteButton.addEventListener('click' , () => {
            ...
            todoDelete.splice(index, 1);  // Deletes the item with index 'index'
            localStorage.setItem('todoList', JSON.stringify(todoDelete)); // Update local Storage .
